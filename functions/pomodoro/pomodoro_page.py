...
class PomodoroMainPage(QWidget):
    def __init__(self, timerProxy: AbstractTimerProxy, settings):
        ...
        self.timerProxy.finished.connect(lambda: print('finished'))
    ...
    def display(self):
        ...
        print('progress value:', self.ui.progress.value)
