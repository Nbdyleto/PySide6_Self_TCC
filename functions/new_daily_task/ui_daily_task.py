...
"}")
        ...
        self.btnAddTask = QtWidgets.QPushButton(self.frame_6)
        self.btnAddTask.setObjectName("btnAddTask")
        self.horizontalLayout_3.addWidget(self.btnAddTask, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignBottom)
    ...
    def retranslateUi(self, DailyTaskPage):
        ...
        self.btnAddTask.setText(_translate("DailyTaskPage", "Adicionar"))
