...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.pushButton_4.setStyleSheet("background-repeat: no-repeat; \n"
"border-radius: 20px;\n"
"text-align: center;")
        self.pushButton_4.setObjectName("pushButton_4")
        self.horizontalLayout_8.addWidget(self.pushButton_4)
        self.btnPomodoroSettings = QtWidgets.QPushButton(self.frame_9)
        self.btnPomodoroSettings.setStyleSheet("background-repeat: no-repeat; \n"
"border-radius: 20px;\n"
"text-align: center;")
        self.btnPomodoroSettings.setObjectName("btnPomodoroSettings")
        self.horizontalLayout_8.addWidget(self.btnPomodoroSettings)
...
"text-align: center;")
        ...
        self.lcdPomodoroTimer = QtWidgets.QLCDNumber(self.tabWidgetPage1)
        font = QtGui.QFont()
        font.setBold(False)
...
"text-align: center;")
    ...
    def retranslateUi(self, Widget):
        ...
        self.pushButton_4.setText(_translate("Widget", "Atualizar Estatísticas"))
        self.btnPomodoroSettings.setText(_translate("Widget", "Settings"))
